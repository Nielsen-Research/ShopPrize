...
<jsp:include page="header.jsp" />  
	  ...
	  <div class="col-lg-3 col-md-6">
							<div class="panel panel-primary">
								...
								<a href="${pageContext.request.contextPath}/pendingImageList/${userid}">
					...
					<div class="col-lg-3 col-md-6">
							<div class="panel panel-primary">
								...
								<a href="${pageContext.request.contextPath}/pendingReviewList/${userid}">
									<div class="panel-footer">
										<span class="pull-left">View Details</span>
										<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
										<div class="clearfix"></div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="panel panel-primary">
								...
								<a href="${pageContext.request.contextPath}/approvedImageList/${userid}">
									<div class="panel-footer">
										<span class="pull-left">View Details</span>
										<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
										<div class="clearfix"></div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="panel panel-primary">
								...
								<a href="${pageContext.request.contextPath}/rejectedImageList/${userid}">
									<div class="panel-footer">
										<span class="pull-left">View Details</span>
										<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
										<div class="clearfix"></div>
 ...
 { 
   $.ajax({
 	...
 	type : "POST",
          url : '${pageContext.request.contextPath}/getImagesByAssignedUser',
          data:{userId : userid,status:"PENDING"},
