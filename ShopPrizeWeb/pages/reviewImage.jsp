...
<jsp:include page="header.jsp" />  
	  ...
	  <div class="main-content">
		 ...
		 <h3>Review Image</h3>
			...
			<h4>Reciept Data</h4>
			<form method="post" action="${pageContext.request.contextPath}/updateReceiptData">
			...
			<input type="hidden" id="startTime" name="startTime" value="${startTime}">
				<div class="form-group">
                  ...
                  <input class="form-control" id="receiptId"  name="receiptId"   value="${receiptInfo.receiptId}" type="text" >
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Purchase Date</label>
                  <input class="form-control" id="purchaseDate" name="purchaseDate" value="${receiptInfo.purchaseDate}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Purchase Time</label>
                  <input class="form-control" id="purchaseTime" name="purchaseTime" value="${receiptInfo.purchaseTime}" type="text">
                </div>
                <div class="form-group">
                  <label class="control-label" for="focusedInput">Purchase Code</label>
                  <input class="form-control" id="purchaseCode" name="purchaseCode" value="${receiptInfo.purchaseCode}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Store Name</label>
                  <input class="form-control" id="storeName" name="storeName" value="${receiptInfo.storeName}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Store Phone #1</label>
                  <input class="form-control" id="storePhone1" name="storePhone1" value="${receiptInfo.storePhone}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Store Phone #2</label>
                  <input class="form-control" id="storePhone2" name="storePhone2" value="${receiptInfo.storePhone2}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Address</label>
                  <input class="form-control" id="address" name="address" value="${receiptInfo.address}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Total Amount</label>
                  <input class="form-control" id="totalAmount" name="totalAmount" value="${receiptInfo.totalAmount}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Discount</label>
                  <input class="form-control" id="discount" name="discount" value="${receiptInfo.discount}" type="text">
                </div>
				<div class="form-group">
                  <label class="control-label" for="focusedInput">Discount Description</label>
                  <input class="form-control" id="discountDesc" name="discountDesc" value="${receiptInfo.discountDescription}" type="text">
                </div>
                <div class="form-group">
                  <label class="control-label" for="focusedInput">Total No. of Item</label>
                  <input class="form-control" id="totalNoOfItem" name="totalNoOfItem"  value="${receiptInfo.totalNoOfItem}" type="text">
                </div>
	...
	var y= 1;
	  ...
	  x++;
		...
		var htmlElement='<div class="item">'
			+'<input type="hidden" id="itemId[]" name="itemId[]" value="NA">'
				+'<div class="element" style="width:18%;float:left; margin-left:5px;">'
				+'<div class="form-group">'
               + '<label class="control-label" for="focusedInput">Item Description</label>'
